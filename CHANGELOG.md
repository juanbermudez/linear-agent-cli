...
- add document list and view commands with filtering and markdown rendering
- add VCS integration for document commands with --current-project flag (auto-detects project from issue context)
- add project create, update, delete, and restore commands with status and team management
- add cross-entity integration: --with-doc flag to create project with design document in one command
- add project milestone create, list, update, and delete commands
- add project status update commands (update-create and updates-list)
- add JSON output support to project list and view commands for AI agent integration
- add initiative create, update, list, and view commands with status and owner management
- add initiative archive and restore commands
- add initiative project management commands (project-add and project-remove)
