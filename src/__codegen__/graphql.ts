...
export type GetWorkflowStatesQuery = { __typename?: 'Query', team: { __typename?: 'Team', states: { __typename?: 'WorkflowStateConnection', nodes: Array<{ __typename?: 'WorkflowState', id: string, name: string, type: string, position: number }> } } };
