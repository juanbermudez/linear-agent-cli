...
export type UnarchiveInitiativeMutation = { __typename?: 'Mutation', initiativeUnarchive: { __typename?: 'InitiativeArchivePayload', success: boolean, entity?: { __typename?: 'Initiative', id: string, name: string, url: string } | null } };
